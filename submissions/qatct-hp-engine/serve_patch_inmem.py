...
# Robust install: if gemma4 is already imported (e.g. the engine sitecustomize
# pulled it in first), patch it directly; otherwise install the import-finder.
if _TARGET_MODULE in sys.modules:
    _apply_inmem_patch(sys.modules[_TARGET_MODULE])
else:
