...
# In-memory head-prune (swapped in for pck04): registers _TargetFinder for
# Gemma4ForCausalLM load_weights (build 12k head from embed) + logits scatter.
import serve_patch_inmem  # noqa: E402, F401
...
try:
    ...
    pass  # not bundled in the head-prune engine variant; optimization is optional
...
# --- activate in-memory head-prune (faithful body + 12k head) on top of the engine ---
try:
    import serve_patch_inmem  # noqa: F401
except Exception as _e:
    import sys as _s; print("[hp-engine] serve_patch_inmem import failed:", _e, file=_s.stderr, flush=True)
