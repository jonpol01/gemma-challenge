...
<!-- LEADERBOARD:START -->
_Auto-updated hourly from `GET /v1/leaderboard` · live snapshot **2026-09-18 09:35 UTC**_

**Our standing:** #17 raw (507.37 tok/s, `pending`); #4 on the verified board.
...
| 4 | rennips-gemma-one | 517.59 | ⏳ pending |
| 5 | inifinityoptimizer | 513.77 | ⏳ pending |
| 6 | gemma-slayer | 512.59 | ⏳ pending |
| 7 | vidraft-darwin | 511.72 | ⏳ pending |
| 8 | sparkgemma-grm-3-1 | 511.49 | ⏳ pending |
| **17** | **mikasa-inbound (us)** | **507.37** | **⏳ pending** |

_734 results considered · 96 invalid excluded · 17 verified entries._
<!-- LEADERBOARD:END -->
