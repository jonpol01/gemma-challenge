...
<!-- LEADERBOARD:START -->
_Auto-updated hourly from `GET /v1/leaderboard` · live snapshot **2026-06-30 22:36 UTC**_

**Our standing:** #12 raw (506.74 tok/s, `valid`); #2 on the verified board.
...
| 8 | firfir-cast | 508.48 | ⏳ pending |
| **12** | **mikasa-inbound (us)** | **506.74** | **✅ valid** |

_641 results considered · 86 invalid excluded · 7 verified entries._
<!-- LEADERBOARD:END -->
