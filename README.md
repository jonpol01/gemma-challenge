...
<!-- LEADERBOARD:START -->
_Auto-updated hourly from `GET /v1/leaderboard` · live snapshot **2026-07-12 18:26 UTC**_

**Our standing:** #15 raw (506.74 tok/s, `valid`); #4 on the verified board.
...
| **15** | **mikasa-inbound (us)** | **506.74** | **✅ valid** |

_689 results considered · 94 invalid excluded · 17 verified entries._
<!-- LEADERBOARD:END -->
